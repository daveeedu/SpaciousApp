    ...
    <div >
      ...
      <Modal className="add" show={show} onHide={handleClose} animation={false}>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end m-3">
          <Button variant="secondary" className="text-uppercase btn btn-light me-md-2" type="submit" onClick={handleClose}>
           cancel
          </Button>
          <Button variant="primary" className="text-uppercase btn btn-light" type="submit" onClick={handleClose}>
           create planet
          </Button>
        </div>
        {/* </Modal.Footer> */}
